...
import { CheckoutSteps, LoadingBox } from "../../components/Index";
...
export default function PlaceOrderPage() {
  ...
  cart.shippingPrice = cart.itemsPrice > 100 ? round(0) : round(4.99);
  cart.taxPrice = round(0.19 * cart.itemsPrice);
  ...
  return (
    <Container className="my-3">
      ...
      <h1 className="my-3">Bestellvorschau</h1>
      <Row>
        <Col md={8}>
          <Card className="mb-3">
            <Card.Body>
